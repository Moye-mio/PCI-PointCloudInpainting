...
//	Inpainter.dumpCloud(pResult);
//
//	pcl::io::savePLYFileBinary("Result/OneTile/Result.ply", *pResult);
//	for (const auto& e : *pRaw)
//		pResult->emplace_back(Point_t(e.x, e.y, e.z, (std::uint8_t)255, (std::uint8_t)255, (std::uint8_t)255, (std::uint8_t)255));
//	pcl::io::savePLYFileBinary("Result/OneTile/Merge.ply", *pResult);
//
//	for (auto& e : *pResult)
//	{
//		e.r = (std::uint8_t)255;
...
//		e.b = (std::uint8_t)255;
//	}
//	pcl::io::savePLYFileBinary("Result/OneTile/MergeNoColor.ply", *pResult);
//}